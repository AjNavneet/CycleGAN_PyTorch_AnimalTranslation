...
if __name__ == '__main__':
    ...
    from models import *  # Import custom models
    from datasets import *  # Import custom datasets
    ...
    decay_epoch = 10
    n_cpu = 4
    img_height, img_width, channels = 256, 256, 3  # Image dimensions
    sample_interval = 100
    n_residual_blocks = 9
    lambda_cyc = 10
    lambda_id = 5.0
    ...
    if epoch != 0:
        # Load pretrained models if resuming training
    ...
    lr_scheduler_D_B = torch.optim.lr.scheduler.LambdaLR(
